...
import com.hello.DiscountManagemenetAppApi.Jobs.Notifications.EndDayJobNotification;
...
public class EndDayJob {
    private final EndDayJobNotification notification;
    ...
    public ItemReader<? extends Campaign> reader(){
        ...
        readerVar.setName("read2");
        readerVar.setMethodName("findByEndDate");
...
//    }
    ...
    public Job job() throws Exception {
        return new JobBuilder("tempJob2", jobRepository)
                .start(step())
